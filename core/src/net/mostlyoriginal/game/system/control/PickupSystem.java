...
public class PickupSystem extends FluidIteratingSystem {
    ...
    private E bestDropSlot(E actor) {
        ...
        if (slotAt == null && actor.hasPlayer()) slotAt = slotHighlightingSystem.getSlotAt(actor.getGridPos(), actor.playerDx(), actor.playerDy());
...
//        item.castsShadow();
    ...
    private E bestItemToPickup(E actor) {
        ...
        if (item == null&& actor.hasPlayer()) item = pickupManager.getOverlapping(actor, actor.playerDx(), actor.playerDy());
