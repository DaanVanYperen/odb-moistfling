...
<tileset version="1.2" tiledversion="1.2.4" name="Astrodrift" tilewidth="48" tileheight="48" tilecount="441" columns="21">
 ...
 <tile id="85">
  <properties>
   <property name="anim" value="debris_small_2"/>
   <property name="entity" value="debris"/>
   <property name="invisible" type="bool" value="true"/>
  </properties>
 </tile>
 <tile id="86">
  <properties>
   <property name="anim" value="debris_small_3"/>
   <property name="entity" value="debris"/>
   <property name="invisible" type="bool" value="true"/>
  </properties>
 </tile>
 <tile id="87">
  <properties>
   <property name="anim" value="debris_big_1"/>
   <property name="entity" value="debris"/>
   <property name="invisible" type="bool" value="true"/>
  </properties>
 </tile>
 ...
 <tile id="90">
  <properties>
   <property name="anim" value="debris_medium_2"/>
   <property name="entity" value="debris"/>
   <property name="invisible" type="bool" value="true"/>
  </properties>
 </tile>
 ...
 <tile id="106" terrain="0,0,,0">
  <properties>
   <property name="anim" value="debris_small_5"/>
   <property name="entity" value="debris"/>
   <property name="invisible" type="bool" value="true"/>
  </properties>
 </tile>
